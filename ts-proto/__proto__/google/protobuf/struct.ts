...
export interface Value {
  kind?:
    ...
    | { $case: "struct_value"; struct_value: { [key: string]: any } | null }
    | { $case: "list_value"; list_value: Array<any> | null }
    | null;
}
...
export const Struct = {
  ...
  fromJSON(object: any): Struct {
    return {
      fields: isObject(object.fields)
        ? Object.entries(object.fields).reduce<{ [key: string]: any | null }>((acc, [key, value]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<Struct>, I>>(object: I): Struct {
    const message = createBaseStruct();
    message.fields = Object.entries(object.fields ?? {}).reduce<{ [key: string]: any | null }>((acc, [key, value]) => {
      if (value !== undefined) {
        acc[key] = value;
      }
      return acc;
...
export const Value = {
  encode(message: Value, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    switch (message.kind?.$case) {
      case "null_value":
        writer.uint32(8).int32(nullValueToNumber(message.kind.null_value));
        break;
      case "number_value":
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.kind = { $case: "null_value", null_value: nullValueFromJSON(reader.int32()) };
          continue;
        case 2:
          if (tag !== 17) {
            break;
